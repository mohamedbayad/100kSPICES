...
urlpatterns = [
    ...
    path("reset/<uidb64>/<token>/", auth_view.PasswordResetConfirmView.as_view(template_name="authentication/reset_password/passwordResetConfirm.html"), name="password_reset_confirm"),
